...
def _concrete_path(path: str) -> str:
    replacements = {
        ...
        "<uuid:assignment_id>": str(uuid4()),
        "<uuid:asset_id>": str(uuid4()),
        "<uuid:artifact_id>": str(uuid4()),
        "<uuid:card_id>": str(uuid4()),
        "<uuid:company_id>": str(uuid4()),
        "<uuid:connection_id>": str(uuid4()),
        "<uuid:context_pack_id>": str(uuid4()),
        "<uuid:credential_id>": str(uuid4()),
        "<uuid:dead_letter_id>": str(uuid4()),
        "<uuid:decision_id>": str(uuid4()),
        "<uuid:deliverable_id>": str(uuid4()),
        "<uuid:department_id>": str(uuid4()),
        "<uuid:draft_id>": str(uuid4()),
        "<uuid:evaluation_id>": str(uuid4()),
        "<uuid:graph_id>": str(uuid4()),
        "<uuid:graph_version_id>": str(uuid4()),
        "<uuid:intent_id>": str(uuid4()),
        "<uuid:installation_id>": str(uuid4()),
        "<uuid:job_id>": str(uuid4()),
        "<uuid:message_id>": str(uuid4()),
