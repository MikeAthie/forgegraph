...
from adapters.api.operating_models.views import (
    ...
    CompanyPackDetailView,
    CompanyPackGenericArchiveView,
    CompanyPackGenericInstallView,
    CompanyPackGenericUpgradeView,
    CompanyPackInstallView,
    CompanyPackListView,
    CompanyPackObjectsView,
...
urlpatterns = [
    ...
    path(
        "companies/<uuid:company_id>/packs",
        CompanyPackListView.as_view(),
        name="company-pack-list",
    ),
    path(
        "companies/<uuid:company_id>/packs/install",
        CompanyPackGenericInstallView.as_view(),
        name="company-pack-install",
    ),
    path(
        "companies/<uuid:company_id>/packs/<uuid:installation_id>",
        CompanyPackDetailView.as_view(),
        name="company-pack-detail",
    ),
    path(
        "companies/<uuid:company_id>/packs/<uuid:installation_id>/upgrade",
        CompanyPackGenericUpgradeView.as_view(),
        name="company-pack-upgrade",
    ),
    path(
        "companies/<uuid:company_id>/packs/<uuid:installation_id>/archive",
        CompanyPackGenericArchiveView.as_view(),
        name="company-pack-archive",
    ),
    path(
        "companies/<uuid:company_id>/packs/<uuid:installation_id>/objects",
        CompanyPackObjectsView.as_view(),
        name="company-pack-objects",
    ),
    path(
