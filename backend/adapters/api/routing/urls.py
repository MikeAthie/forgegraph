...
urlpatterns = [
    ...
    path(
        "policies/<uuid:policy_id>", RoutingPolicyDetailView.as_view(), name="routing-policy-detail"
    ),
    path(
        "records/<uuid:record_id>", RoutingRecordDetailView.as_view(), name="routing-record-detail"
    ),
]
