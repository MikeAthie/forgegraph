...
GATEWAY_CONNECTOR_TIMEOUT_SECONDS = float(
    os.environ.get("GATEWAY_CONNECTOR_TIMEOUT_SECONDS", "10")
)
...
META_GRAPH_ACCESS_TOKEN = os.environ.get("META_GRAPH_ACCESS_TOKEN", "").strip()
