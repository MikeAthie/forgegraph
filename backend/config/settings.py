...
SLO_API_AVAILABILITY_PRODUCTION = float(
    os.environ.get("SLO_API_AVAILABILITY_PRODUCTION", "0.999")
)
...
SLO_WEBSOCKET_SEND_P95_LATENCY_MS = int(
    os.environ.get("SLO_WEBSOCKET_SEND_P95_LATENCY_MS", "2000")
)
...
SLO_TASK_PROJECTION_LAG_P95_MS = int(
    os.environ.get("SLO_TASK_PROJECTION_LAG_P95_MS", "2000")
)
SLO_DEAD_LETTER_VISIBILITY_SECONDS = int(
    os.environ.get("SLO_DEAD_LETTER_VISIBILITY_SECONDS", "30")
)
SLO_SILENT_TASK_LOSS_MAX = int(os.environ.get("SLO_SILENT_TASK_LOSS_MAX", "0"))
SLO_RUNTIME_INTENT_BACKLOG_WARNING = int(
    os.environ.get("SLO_RUNTIME_INTENT_BACKLOG_WARNING", "50")
)
...
SLO_COST_ANOMALY_USD_PER_WINDOW = float(
    os.environ.get("SLO_COST_ANOMALY_USD_PER_WINDOW", "100.0")
)
...
RUN_WS_HEARTBEAT_INTERVAL_SECONDS = int(
    os.environ.get("RUN_WS_HEARTBEAT_INTERVAL_SECONDS", "12")
)
