...
DELIVERABLE_DEFINITIONS: dict[str, DeliverableDefinition] = {
    "client_brief": DeliverableDefinition(
        ...
        label="Client Brief",
        group="intake",
        owner_department_slug="account_management",
    ...
    "message_house": DeliverableDefinition(
        ...
        label="Message House",
        group="strategy",
        owner_department_slug="creative_strategy",
        source_kinds=("whiteboard", "phase"),
    ),
    "launch_readiness_checklist": DeliverableDefinition(
        ...
        group="deployment",
        owner_department_slug="deployment_ops",
    ...
    "measurement_plan": DeliverableDefinition(
        ...
        group="measurement",
        owner_department_slug="analytics",
    ...
    "approval_packet": DeliverableDefinition(
        ...
        group="approval",
        owner_department_slug="client_approval",
        requires_approval=True,
