  ...
  return (
    <div className="min-h-screen">
      ...
      <header className="sticky top-0 z-20 border-b border-zinc-900/8 bg-[color-mix(in_srgb,var(--background)_80%,transparent)] backdrop-blur-2xl dark:border-white/8">
        <div className="mx-auto flex w-full max-w-[1280px] items-center justify-between p-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto flex min-h-[calc(100vh-9rem)] w-full max-w-[1280px] items-center justify-center">
          <div className="grid w-full gap-10 xl:grid-cols-[0.9fr_0.7fr] xl:items-center">
            <section className="hidden xl:block">
              ...
              <h1
                className="mt-4 max-w-3xl text-5xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50"
