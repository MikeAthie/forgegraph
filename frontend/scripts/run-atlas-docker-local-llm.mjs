...
const env = normalizeChildEnv({
  ...
  LIVE_LLM_MODEL: process.env.LIVE_LLM_MODEL ?? "docker.io/ai/llama3.1:latest",
  LIVE_LLM_JUDGE_MAX_TOKENS: process.env.LIVE_LLM_JUDGE_MAX_TOKENS ?? "4096",
  LIVE_LLM_JUDGE_NODE_TIMEOUT_MS: process.env.LIVE_LLM_JUDGE_NODE_TIMEOUT_MS ?? "300000",
