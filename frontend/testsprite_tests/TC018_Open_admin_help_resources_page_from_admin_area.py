...
async def run_test():
    ...
    try:
        ...
        # -> Input the org-admin credentials into the email field (then password) and submit the login form.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Open the Settings page (left navigation) and locate an Admin Help or Support link. If found, open it and verify help/support content is displayed.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div/div[2]/aside/div[2]/div[2]/nav/a[3]').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the 'Open' link for Help (Admin Help) and verify that support/help resources are rendered on the resulting page.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div/div[2]/div/main/div/div/div/div/div[2]/section/div[2]/div/div[3]/div/a').nth(0)
        await asyncio.sleep(3); await elem.click()
