...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields, submit the form, navigate to /credentials, and extract visible UI content to verify credential cards, OAuth integration status, connection checklist, and ensure no metadata editing controls are exposed.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Wait for the sign-in to complete, then navigate to /credentials and inspect the rendered page for credential cards, OAuth integration status, connection checklist, and verify that no credential metadata editing controls are exposed.
