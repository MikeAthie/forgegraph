...
export const DEFAULT_WIZARD_STEPS: WizardStepConfig[] = [
  {
    ...
    description: "Start from a preset or create a blank agent workflow",
    isRequired: true,
    canSkip: false,
  },
  {
    ...
    description: "Define the runtime instructions, model, and behavior",
    isRequired: true,
    canSkip: false,
  },
  {
    id: "tools",
    title: "Choose Tools",
    description: "Define the exact tools the agent is allowed to call",
    isRequired: true,
    canSkip: false,
  },
  {
    id: "memory",
    title: "Memory Mode",
    description: "Choose whether the wizard should add memory nodes",
    isRequired: false,
    canSkip: true,
  },
  {
    id: "output",
    title: "Output Shape",
    description: "Define the final output key for the generated flow",
    isRequired: true,
    canSkip: false,
  },
  {
    id: "review",
    title: "Review Flow",
    description: "Review the generated agent workflow before adding it",
    isRequired: true,
    canSkip: false,
  },
];
