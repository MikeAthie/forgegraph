...
const AnimatedNode = ({
  ...
  >
    <div
      className={`w-10 h-10 rounded-lg mx-auto mb-2 flex items-center justify-center transition-all duration-300 ${
        isActive ? "scale-110" : ""
      } ${color}`}
    >
      {icon}
...
const ConnectionLine = ({ isActive = false, delay = 0 }: { isActive?: boolean; delay?: number }) => (
  ...
  >
    ...
    <div
      className={`w-0 h-0 border-t-4 border-b-4 border-l-6 border-transparent transition-colors duration-300 ${
...
export default function Home() {
  ...
  const typedText = useTypingEffect(["In Minutes", "Without Code", "That Just Work", "Your Way"], 80, 40, 3500);
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          >
            Want to build your own AI agents? Just drag, drop, and connect. No complex setup. No coding headaches. Just
            results.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Ever wonder what happened inside that AI call? Now you can see everything. Every step, every decision,
                every millisecond.
              </p>
            ...
            <div className="bg-[#0d1117] rounded-2xl border border-border overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
              ...
              <pre className="p-4 text-sm overflow-x-auto">
                <code className="text-gray-300">
                  ...
                  {"\n"}
                  {"  "}
                  <span className="text-violet-400">&quot;run_id&quot;</span>
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-emerald-400">&quot;run_8x7kL2mN&quot;</span>
                  <span className="text-gray-500">,</span>
                  {"\n"}
                  {"  "}
                  ...
                  {"\n"}
                  {"  "}
                  <span className="text-violet-400">&quot;duration_ms&quot;</span>
                  <span className="text-gray-500">:</span> <span className="text-amber-400">2847</span>
                  <span className="text-gray-500">,</span>
                  {"\n"}
                  {"  "}
                  <span className="text-violet-400">&quot;nodes&quot;</span>
                  ...
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-emerald-400">&quot;analyze_request&quot;</span>
                  <span className="text-gray-500">,</span>
                  {"\n"}
                  {"      "}
                  <span className="text-violet-400">&quot;type&quot;</span>
                  <span className="text-gray-500">:</span> <span className="text-emerald-400">&quot;prompt&quot;</span>
                  <span className="text-gray-500">,</span>
                  {"\n"}
                  {"      "}
                  <span className="text-violet-400">&quot;model&quot;</span>
                  <span className="text-gray-500">:</span>{" "}
                  <span className="text-emerald-400">&quot;gpt-4-turbo&quot;</span>
                  <span className="text-gray-500">,</span>
                  {"\n"}
                  {"      "}
                  <span className="text-violet-400">&quot;latency_ms&quot;</span>
                  <span className="text-gray-500">:</span> <span className="text-amber-400">1823</span>
                  {"\n"}
                  {"    }"}
                  {"\n"}
                  {"  "}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative bg-linear-to-br from-primary/20 via-violet-500/20 to-fuchsia-500/20 rounded-3xl border border-primary/30 p-12 lg:p-16 overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">Ready to Build Your First Agent?</h2>
              <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
                Takes 2 minutes to sign up. Your first agent could be running in 5. No credit card needed.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto text-base px-8 bg-background/50 backdrop-blur"
                  asChild
                >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-sm text-muted-foreground">
              ...
              <Link
                href="https://github.com/forgegraph/forgegraph"
