      ...
      ? [
          {
            ...
            env: {
              ...
              CORS_ALLOWED_ORIGINS: trustedFrontendOrigins,
              CSRF_TRUSTED_ORIGINS: trustedFrontendOrigins,
              ...
              AUTH_REGISTER_THROTTLE_RATE: process.env.PLAYWRIGHT_AUTH_REGISTER_THROTTLE_RATE ?? "10000/min",
