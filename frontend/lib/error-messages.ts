...
export const ERROR_FALLBACKS = {
  ...
  graph: {
    create: "Unable to create the operating model. Please try again.",
    update: "Unable to save changes. Please try again.",
    delete: "Unable to delete the operating model. Please try again.",
    clone: "Unable to clone the operating model. Please try again.",
    load: "Unable to load the operating model. Please try again.",
  },
  run: {
    start: "Unable to start the operation. Please try again.",
    stop: "Unable to stop the operation. Please try again.",
    resume: "Unable to resume the operation. Please try again.",
    cancel: "Unable to cancel the operation. Please try again.",
  },
  prompt: {
