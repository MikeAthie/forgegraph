...
func (c *engineServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/engine.EngineService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *engineServiceClient) StartRun(ctx context.Context, in *StartRunRequest, opts ...grpc.CallOption) (*StartRunResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/engine.EngineService/StartRun", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *engineServiceClient) GetRunStatus(ctx context.Context, in *GetRunStatusRequest, opts ...grpc.CallOption) (*GetRunStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/engine.EngineService/GetRunStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *engineServiceClient) CancelRun(ctx context.Context, in *CancelRunRequest, opts ...grpc.CallOption) (*CancelRunResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/engine.EngineService/CancelRun", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *engineServiceClient) ResumeRun(ctx context.Context, in *ResumeRunRequest, opts ...grpc.CallOption) (*ResumeRunResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/engine.EngineService/ResumeRun", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EngineService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/engine.EngineService/Ping",
	}
...
func _EngineService_StartRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/engine.EngineService/StartRun",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EngineService_GetRunStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/engine.EngineService/GetRunStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EngineService_CancelRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/engine.EngineService/CancelRun",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EngineService_ResumeRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/engine.EngineService/ResumeRun",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var EngineService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "engine/proto/engine.proto",
}
...
func (c *memoryServiceClient) RetrieveMemory(ctx context.Context, in *RetrieveMemoryRequest, opts ...grpc.CallOption) (*RetrieveMemoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/engine.MemoryService/RetrieveMemory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMemoryServiceServer should be embedded to have forward compatible implementations.
...
func _MemoryService_RetrieveMemory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/engine.MemoryService/RetrieveMemory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
